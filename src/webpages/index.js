...
import Example from "../printComponent/Example";
import Example2 from "../printComponent/Example2";
  ...
  return (
    <Router>
      ...
      <Switch>
		...
		<Route path="/print1" exact component={Example2} />
        <Route path="/print2" exact component={Example} />
